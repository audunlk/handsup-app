...
import { listGroupsByKey, updateUser, createGroup } from '../services/accountSetup'
...
export default function JoinTeam({navigation}) {
  ...
  return (
    <View style={styles.container}>
      ...
      >
                <Header navigation={navigation} title={'Create Group'} showExit={true}/>

        <View style={styles.body}>
            <Text>Create a Team</Text>
            <TextInput placeholder='Enter Team Name' value={teamName} onChangeText={setTeamName} />
            <Pressable 
                style={styles.btn}
